...
public class SpiritFluidStorageImpl extends SpiritFluidStorage {
    ...
    private SpiritFluidStorageImpl(long maxAmount, long transferRate, Runnable onCommit, Predicate<FluidStack> validFluid) {
        ...
        this.fabricFluidStorage = new SingleVariantStorage<FluidVariant>() {
            ...
            protected boolean canInsert(FluidVariant variant) {
                return validFluid.test(FluidStackHooksFabric.fromFabric(variant, transferRate));
            }
            @Override
    ...
    public static SpiritFluidStorage create(long capacity, long transferRate, Runnable onCommit, Predicate<FluidStack> validFluid) {
        return new SpiritFluidStorageImpl(capacity, transferRate, onCommit, validFluid);
    }
